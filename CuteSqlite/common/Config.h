...
typedef enum {
	...
	EXPORT_CSV_COLUMN_NAME_COMBOBOX_ID,
	EXPORT_CSV_FIELD_TERMINAATED_BY_COMBOBOX_ID,
	EXPORT_CSV_LINE_TERMINAATED_BY_COMBOBOX_ID,
	EXPORT_CSV_NULL_AS_KEYWORD_COMBOBOX_ID,
	EXPORT_CSV_CHARSET_COMBOBOX_ID,
} ComboBoxId;
