...
public:
	...
	BEGIN_MSG_MAP_EX(ResultListPage)
		...
		COMMAND_ID_HANDLER_EX(Config::LISTVIEW_EXPORT_BUTTON_ID, OnClickExportButton)
		COMMAND_ID_HANDLER_EX(Config::LISTVIEW_COPY_BUTTON_ID, OnClickCopyButton)
		COMMAND_ID_HANDLER_EX(Config::LISTVIEW_FILTER_BUTTON_ID, OnClickFilterButton)
		COMMAND_ID_HANDLER_EX(Config::LISTVIEW_REFRESH_BUTTON_ID, OnClickRefreshButton)
