...
public:
	...
	BEGIN_MSG_MAP_EX(ResultTableDataPage)
		...
		COMMAND_ID_HANDLER_EX(Config::LISTVIEW_COPY_ROW_BUTTON_ID, OnClickCopyRowButton)
		COMMAND_ID_HANDLER_EX(Config::LISTVIEW_SAVE_BUTTON_ID, OnClickSaveButton)
		COMMAND_ID_HANDLER_EX(Config::LISTVIEW_DELETE_BUTTON_ID, OnClickDeleteButton)
		COMMAND_ID_HANDLER_EX(Config::LISTVIEW_CANCEL_BUTTON_ID, OnClickCancelButton)
