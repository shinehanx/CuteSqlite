 ...
 * @file   TriggerUserRepository.h
 * @brief  Operations on triggers in the user database
 * 
 * @author Xuehan Qin
 * @date   2023-05-20
 *********************************************************************/
...
class TriggerUserRepository : public BaseUserRepository<TriggerUserRepository>
{
public:
